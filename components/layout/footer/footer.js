...
function Footer() {
  return(
    ...
    <footer class="px-4 md:px-20 lg:px-32 xl:px-60 2xl:px-80 py-8 flex flex-col md:flex-row justify-between items-center border-t-2 relative bg-gray-100 inset-x-0 bottom-0">
      <div class="flex">
        <div>
