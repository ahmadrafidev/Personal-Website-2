...
function Portfolio() {
  return (
    <section id="projects" class="px-2 md:px-20 lg:px-48 xl:px-60 2xl:px-96 min-h-screen pt-6 md:pt-14 pb-6 md:pb-14 bg-white dark:bg-secondary font-secondary">
      <div class="container mx-auto">
        <div class="flex mb-10">
          <h1 class="text-xl sm:text-2xl md:text-6xl font-bold font-primary title-font mb-4 uppercase">
            Projects.
          </h1>
        </div>
